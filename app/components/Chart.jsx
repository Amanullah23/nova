...
import headerImg from "@/public/chart.png";

const CompanyOrganization = () => {
  return (
    <section className="py-16 bg-gray-100 dark:bg-green-900">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-3xl font-serif md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
          Company Chart
        </h2>
        <span className="block w-16 h-1 bg-green-600 mx-auto mt-3 mb-4 rounded"></span>
        <p className="mb-5 font-serif text-gray-600 text-lg px-10 max-w-4xl text-center mx-auto">
