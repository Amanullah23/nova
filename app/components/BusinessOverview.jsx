...
const BusinessOverview = () => {
  return (
    <section className="relative w-full py-32 px-6 md:px-12 bg-[#f5f0e8] overflow-hidden">
      ...
      {/* Decorative circles */}
      <div className="absolute -top-16 -left-16 w-64 h-64 rounded-full border-[40px] border-[#d4a348]/10 pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-end mb-20">
          <div>
            ...
            <div className="overflow-hidden">
              ...
              >
                How We
                <br />
                <span className="text-[#d4a348]">Operate</span>
              </motion.h2>
            </div>
          </div>
          ...
          >
            <p className="text-[#5a5040] text-lg leading-relaxed">
              ...
              strategies, and the values that drive every decision we make
              as a company.
            </p>
            <div className="flex items-center gap-6">
              <div className="flex flex-col">
                <span className="text-3xl font-black text-[#0a0a0a]">3</span>
                <span className="text-[11px] text-[#8a7a60] uppercase tracking-widest">Pillars</span>
              </div>
              <div className="w-px h-12 bg-[#d4a348]/40" />
              <div className="flex flex-col">
                <span className="text-3xl font-black text-[#0a0a0a]">20+</span>
                <span className="text-[11px] text-[#8a7a60] uppercase tracking-widest">Partners</span>
              </div>
              <div className="w-px h-12 bg-[#d4a348]/40" />
              <div className="flex flex-col">
                <span className="text-3xl font-black text-[#0a0a0a]">100%</span>
                <span className="text-[11px] text-[#8a7a60] uppercase tracking-widest">On-Time</span>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          {data.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Image */}
                <div className="relative w-full h-[140px] rounded-2xl overflow-hidden bg-[#f5f0e8]">
                  <Image
                    src={item.image}
                    alt={item.title}
                    fill
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="px-3 py-[4px] bg-[#d4a348] text-[#0a0a0a] text-[10px] font-black tracking-widest uppercase rounded-full">
                      {item.tag}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-[#0a0a0a] font-black text-[17px] leading-snug tracking-tight group-hover:text-[#d4a348] transition-colors duration-300">
                    {item.title}
                  </h3>
                ...
                {/* Arrow link */}
                <div className="mt-auto pt-4 border-t border-[#f0e8d8] flex items-center justify-between">
                  <span className="text-[12px] font-bold text-[#0a0a0a] bg-[#f5f0e8] px-3 py-[5px] rounded-full flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#d4a348]" />
                    {item.tag}
                  </span>
                  <div className="w-8 h-8 rounded-full bg-[#f5f0e8] border border-[#e8e0d0] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <ArrowUpRight className="w-4 h-4 text-[#d4a348]" />
                  </div>
                </div>
