      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="w-full">
          <div>
            ...
            <p className="text-gray-600 dark:text-white">Dasht-e Barchi, Kabul - Afghanistan</p>
          </div>
          <div>
            <p className="text-lime-500 text-xl font-bold mt-5">Phone</p>
            <p className="text-gray-600 dark:text-white">+9374 944 2276</p>
          </div>
          <div>
            <p className="text-lime-500 text-xl font-bold mt-5">Email</p>
            <p className="text-gray-600 dark:text-white">nova.inc.cc@gmail.com</p>
          </div>
          <div className="">
            <Map/>
          </div>
